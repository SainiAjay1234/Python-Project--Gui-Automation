...
time.sleep(2)
dlg8 = dlg1.child_window(title="Module 1 (Compact Contact Input (CI)) (Stopped)", control_type="Text")
...
#dlg9 = dlg1.child_window(title="1", control_type="Text").wrapper_object()
dlg9 = dlg1.child_window(title="Enable All", control_type="Button")
time.sleep(2)
dlg9.EnableAll.click_input(button='down', double='true')
time.sleep(3)
dlg10 = dlg1.child_window(title="Enable All", control_type="Button")
dlg10.EnableAll.double_click_input(button='left')
time.sleep(3)
dlg10.type_keys('{TAB 5}'+'{SPACE}')
time.sleep(4)
dlg11 = dlg1.child_window(title="Inject", control_type="Button")
dlg11.Inject.click_input(button='down', double='true')
time.sleep(2)
dlg12 = dlg1.child_window(title="Inject", control_type="Button")
...
if var1 == True :
    with open("C:\\Automation\\TestFileForPacked.txt",'w')as f : print ("PACKED_P1 value changed to 0008H",file=f)

else:
    with open("C:\\Automation\\TestFileForPacked.txt",'w')as f :  print ("Test case is failed to change the value",file=f)




#dlg11 = dlg1.child_window(title="3", control_type="Text")
#dlg11.select()
#app.OvationVirtualRNIConfigurationManager.print_control_identifiers()
#child_window(title="Inject", control_type="Button")
...
#dlg9 = dlg1.child_window(title="Enable All", control_type="Button")
#dlg9.select()
#dlg1.EnableAll.click_input(button='down', double='true')
#dlg9.select().click_input(button='down', double='true')
#dlg9.click_input(button='down', double='true')



#child_window(title="8", control_type="Text")
#child_window(title="Enable All", control_type="Button")
#child_window(title="Injection Bit Values", control_type="Text")
#child_window(title="Inject", control_type="Button")
#app.OvationVirtualRNIConfigurationManager.print_control_identifiers()
#time.sleep(3)
#dlg9 = dlg1.DigitalValueCombo.click_input(button='down', double='true')
#time.sleep(2)
...
#dlg7.type_keys('{DOWN}'+'+{RIGHT}'+'{TAB}{TAB}{TAB}{TAB}{SPACE}'+'{TAB 7}'+'{DOWN}'+'{TAB 5}'+'{ENTER}'+'{TAB 6}'+'{RIGHT}'+'{DOWN}'+'{RIGHT}'+'{DOWN}'+'{TAB}{TAB}{TAB}{DOWN}'+'{TAB}{ENTER}')
#time.sleep(1)
#dlg8 = dlg1.child_window(title="Inject", control_type="Button").wrapper_object()
#dlg8.click_input()
#dlg8.type_keys('{TAB 5}'+'{ENTER}'+'{TAB 6}{DOWN}'+'{RIGHT}'+'{DOWN}')
#ime.sleep(2)
#dlg8.type_keys('{TAB 3}')
#child_window(auto_id="DigitalValueCombo", control_type="ComboBox")

#child_window(title="Digital Value: ", control_type="Text")

# child_window(title="Inject Digital Value", control_type="Text")
#child_window(title="Set a digital value and click Inject to force the value to be changed", control_type="Text")
#app.OvationVirtualRNIConfigurationManager.print_control_identifiers()
#dlg10 = dlg9.item_count()


#dlg9.type_keys('{TAB 3}')
