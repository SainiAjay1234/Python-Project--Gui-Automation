...
var1 = dlg.child_window(title="50.0", control_type="Custom").exists(1)

if var1 == True :
    with open("C:\\Automation\\TestFileForAnalog.txt",'w')as f : print ("ANALOG_A7 value changed to 50",file=f)

else:
    with open("C:\\Automation\\TestFileForAnalog.txt",'w')as f :  print ("Test case is failed to change the value",file=f)
