...
#Module3 ANALOG value Inject value
app.OvationVirtualRNIConfigurationManager.print_control_identifiers()
dlg9 = dlg1.child_window(title="Module 4 (Analog Output (AO)) (Stopped)", control_type="Text")

#dlg9 = dlg1.child_window(title="Module 3 (16-Channel T/C Input (HDTI)) (Stopped)", control_type="Text")
