...
time.sleep(2)
dlg8.type_keys('{TAB 5}'+'{ENTER}'+'{TAB 6}{DOWN}'+'{RIGHT}'+'{DOWN}'+'{TAB 3}'+'{DOWN}'+'{TAB}')
time.sleep(3)
...
#dlg10 = dlg1.child_window(auto_id="DigitalValueCombo", control_type="ComboBox")
#dlg10.DigitalValue.double_click_input(button='left')
...
#child_window(title="Parameter row 0", control_type="DataItem")
#child_window(title="Field row 0", control_type="DataItem")
#child_window(title="Value row 0", control_type="DataItem")


var1 = dlg.child_window(title="Parameter row 0", control_type="DataItem").exists(1)

if var1 == True :
    with open("C:\\Automation\\TestFileForDigital.txt",'w')as f : print ("DIGITAL_D1 value changed to 0",file=f)

else:
    with open("C:\\Automation\\TestFileForDigital.txt",'w')as f :  print ("Test case is failed to change the value",file=f)
